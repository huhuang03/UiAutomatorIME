...
package duomai.com.inputmethod.pinyin.common;
...
import duomai.com.inputmethod.pinyin.skb.SkbTemplate;
import duomai.com.inputmethod.pinyin.skb.SoftKey;
import duomai.com.inputmethod.pinyin.skb.SoftKeyToggle;
import duomai.com.inputmethod.pinyin.skb.SoftKeyType;
      ...
      while (mXmlEventType != XmlResourceParser.END_DOCUMENT) {
        ...
        if (mXmlEventType == XmlResourceParser.START_TAG) {
          ...
          if (XMLTAG_KEYBOARD.compareTo(attr) == 0) {
            ...
            int rowId = getInteger(xrp, XMLATTR_ROW_ID, SoftKeyboard.KeyRow.ALWAYS_SHOW_ROW_ID);
