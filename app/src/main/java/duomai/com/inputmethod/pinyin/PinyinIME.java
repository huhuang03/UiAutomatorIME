...
package duomai.com.inputmethod.pinyin;
...
import duomai.com.inputmethod.R;
import duomai.com.inputmethod.pinyin.common.Environment;
import duomai.com.inputmethod.pinyin.common.KeyMapDream;
import duomai.com.inputmethod.pinyin.common.SoundManager;
import duomai.com.inputmethod.pinyin.setting.Settings;
import duomai.com.inputmethod.pinyin.setting.SettingsActivity;
import duomai.com.inputmethod.pinyin.skb.SoftKey;
import duomai.com.inputmethod.pinyin.ui.BalloonHint;
import duomai.com.inputmethod.pinyin.ui.CandidatesContainer;
import duomai.com.inputmethod.pinyin.ui.ComposingView;
import duomai.com.inputmethod.pinyin.ui.SkbContainer;
...
//      Log.i(TAG, "event: " + event);
  ...
  /**
   * 处理uiautomator里面的特殊输入
   */
  private boolean handleUiAutomator(int keyCode, KeyEvent event) {
